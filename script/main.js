(function ()  {
  ...
  theImages.forEach(function(element, index) {
    //loop through and do stuf to each lement at the top of the page
    element.addEventListener('click', changesElements, false);
  });
  ...
  changesElements.call(document.querySelector('#spring'));
})();
